...
public static class SetupLanguageCatalog
{
    ...
    private static SetupLanguageResources CreateEnglishResources()
    {
        return new SetupLanguageResources
        {
            ...
            RailWelcomeLabel = "01  Welcome",
            RailConfigureLabel = "02  Configure",
            RailReviewLabel = "03  Review",
            RailApplyLabel = "04  Apply",
            RailCompleteLabel = "05  Complete",
    ...
    private static SetupLanguageResources CreateChineseResources()
    {
        return new SetupLanguageResources
        {
            ...
            RailWelcomeLabel = "01  欢迎",
            RailConfigureLabel = "02  配置",
            RailReviewLabel = "03  复核",
            RailApplyLabel = "04  执行",
            RailCompleteLabel = "05  完成",
