...
namespace RS.HMI.Client.Views
{
    ...
    public partial class LoginView : RSWindow
    {
        ...
        private async Task<OperateResult<ImgVerifyModel>> RSImgVerify_InitVerifyControlAsync()
        {
            ...
            var getImgVerifyModelResult = await this.GetLoading().InvokeLoadingActionAsync<ImgVerifyModel>(async (cancellationToken) =>
              {
            ...
            {
                await this.GetWinMessageBox().ShowMessageAsync(getImgVerifyModelResult.Message);
            }
