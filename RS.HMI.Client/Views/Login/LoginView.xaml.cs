...
namespace RS.HMI.Client.Views
{
    ...
    public partial class LoginView : RSWindow
    {
        ...
        private async void BtnLogin_Click(object sender, RoutedEventArgs e)
        {
            ...
            var operateResult = await this.LoginForm.InvokeLoadingActionAsync(async (cancellationToken) =>
              {
                  //验证用户登录
        ...
        private async Task<OperateResult<ImgVerifyModel>> RSImgVerify_InitVerifyControlAsync()
        {
            ...
            var getImgVerifyModelResult = await this.LoginForm.InvokeLoadingActionAsync<ImgVerifyModel>(async (cancellationToken) =>
              {
