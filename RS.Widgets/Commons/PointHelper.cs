...
namespace RS.Widgets.Commons
{
    public static class PointHelper
    {
        ...
        {
            return new POINT(DoubleHelper.DoubleToInt(point.X), DoubleHelper.DoubleToInt(point.Y));
        }
        ...
        {
            RECT result = default;
            result.Top = DoubleHelper.DoubleToInt(rect.Y);
            result.Left = DoubleHelper.DoubleToInt(rect.X);
            result.Bottom = DoubleHelper.DoubleToInt(rect.Bottom);
            result.Right = DoubleHelper.DoubleToInt(rect.Right);
            return result;
        }
