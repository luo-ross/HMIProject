...
namespace RS.HMIServer.DAL.SqlServer
{
    /// <summary>
    /// 数据库上下文
    /// </summary>
    internal class RSAppDbContext : DbContext
    {
        ...
        {
            var typeList = Assembly.GetExecutingAssembly().GetTypes().Where(t => t.Namespace == "RS.HMIServer.DAL.Mapping" && t.ReflectedType == null);
